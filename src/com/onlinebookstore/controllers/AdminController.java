  ...
  private static void processOrders() {
    ...
    if (order != null) {
        ...
        if (approve.equals("yes") || approve.equals("y")) {
            ...
            actionHistory.push("Approved and processed order ID: " + order.getId());
            System.out.println("Order ID " + order.getId() + " has been approved and processed.");
        } else {
            System.out.println("Order approval and processing cancelled.");
            orderService.addOrderToQueue(order); // Re-enqueue the order
        }
    } else {
  ...
  private static void undoLastAction() {
    ...
    if (lastAction.startsWith("Approved and processed order ID: ")) {
        ...
        if (order != null) {
            ...
            orderService.addOrderToQueue(order); // Re-enqueue the order at the bottom of the queue
        }
    } else {
